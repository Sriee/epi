...
public class ArrayUtilIndexOfTest {
    ...
    public void testIndexOfGenericArray() {
        ...
        Long[] actualLong = { (long) 654, (long) 4048, (long) 3338, (long) 6306, (long) 3963, (long) 5575, (long) 5677,
                (long) 2442, (long) 3826, (long) 3696, (long) 2233, (long) 3431, (long) 5346, (long) 1667, (long) 4684,
                (long) 4007, (long) 3876, (long) 3245, (long) 86, (long) 4855 };
        ...
        Float[] fNone = null;
        Float[] fEmpty = {};
        Float[] actualFloat = { (float) 469.3946, (float) 124.9198, (float) 893.9692, (float) 269.7879,
                (float) 238.9134, (float) 794.5137, (float) 576.5812, (float) 667.9545, (float) 415.4388,
                (float) 684.2454, (float) 276.4853, (float) 274.0731, (float) 569.1978, (float) 458.5947,
                (float) 14.6265, (float) 660.5167, (float) 600.5318, (float) 247.9708, (float) 317.594,
                (float) 242.2006 };
