...
public class TestListSort {
    ...
    public void testInsertionSortEdgeCases() {
        ...
        ListNode toSort = new ListNode(1);
    ...
    public void testInsertionSortCorrectness() {
        ...
        // To sort
        ListNode toSort = new ListNode(Integer.MIN_VALUE);
        ...
        // Sorted
        ListNode expected = new ListNode(Integer.MIN_VALUE);
        ...
        ListNode sorted = is.insertionSort(toSort);
        assertEquals(8, ListUtil.length(sorted));

        ListNode _ex = expected, _so = sorted;
    ...
    public void testMergeSortEdgeCases() {
        ...
        ListNode sorted = is.mergeSort(toSort);
