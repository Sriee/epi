 ...
 * 
 * Run Time: 79 ms. Above average run time. Optimal solution uses a hack without storing the actual letter
 * 
 */
public class WordDictionary {
	...
	/**
	 * Search for a word in the word dictionary. Should support regex "." 
	 * 
	 * Example:
	 * 		Word Dictionary [bad, mad]
	 * 		search("b.d") -> true
	 * 		search(".") -> false; since there is no word ending with single character 
	 * 
