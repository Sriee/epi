...
/**
 * Leet code. Solution -> Accepted Run Time: 144 ms. Above average run time.
 * Trick was to insert words in trie in reverse order
 */
public class StreamChecker {
    ...
    /**
     * For some k >= 1, the last k characters queried (in order from oldest to
     * newest, including this letter just queried) spell one of the words in the
     * given list.
     * 
