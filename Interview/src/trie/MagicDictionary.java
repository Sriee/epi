...
/**
 * Leet code. Solution -> Accepted Run Time: 47 ms. Average run time. Optimal
 * soultion involves a hack of not storing letters in a Trie Node Implement
 * Magic Dictionary
 */
public class MagicDictionary {
     ...
     * @return true if the word to search is found with only one diff, false
     *         otherwise
     */
    ...
    /**
     * Search Magic Dictionary for a word. The word should match only if atmost one
