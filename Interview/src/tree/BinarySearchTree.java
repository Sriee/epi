...
public class BinarySearchTree {
     ...
     * sorted array create a height balanced binary search tree.
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 1 ms. Optimal solution Given a
     * linked list which is sorted create a height balanced binary search tree.
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 1 ms. Above average run time.
     * Iterative implementation Find kth smallest element in a Binary Search Tree
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 0 ms. Optimal run time. Recursive
     * implementation
     * 
     * @param root of BST
     * @param k
