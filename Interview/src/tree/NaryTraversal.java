...
public class NaryTraversal {
    ...
    /**
     * Leet code. Solution -> Accepted Depth of a n-ary tree.
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 3 ms. Above average run time. Give
     * the root of the n-ary node, retrieve the nodes at each level
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Pre-order traversal of an n-ary tree.
    ...
    /**
     * Leet code. Solution -> Accepted Post-order traversal of an n-ary tree.
     * (Iterative Implementation)
     * 
     * @param root of the n-ary tree
