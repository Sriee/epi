...
public class Miscellaneous {
     ...
     * represent a number. An example is the root-to-leaf path 1->2->3 which
     * represents the number 123. Compute the total sum of root-to-leaf path Leet
    ...
    /**
     * Add one row to the tree At 2 nodes at depth d. Left subtree of node at depth
     * d = left subtree of node at depth d - 1. It's right will be null Right
     * subtree of node at depth d = right subtree of node at depth d - 1. It's left
     * will be null If depth to insert is at 1. The new root node will be the one to
     * be inserted. New root left subtree would be the old root. New root right
     * subtree would be null Leet code. Solution -> Accepted
     * 
     * @param root of the tree
     * @param v    value for the new node
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 5 ms. Below average solution. We
     * take time to create a serialize version of the tree before we do breath first
     * search Given the root & target nodes of the binary tree, find nodes that are
     * k distance from the target node. Approach: 1. Serialize the Binary Tree -
     * Should find a way to reduce this time. 2. Do BFS
     * 
     * @param root   of the tree
     * @param target node
     * @param K      distance
    ...
    public List<Integer> distanceK(TreeNode root, TreeNode target, int K) {
        ...
        /**
         * Why we use isVisited as map instead of an boolean array? What would be the
         * result of serialization for a skewed right tree?
         */
    ...
    /**
     * Helper method to flatten binary tree This approach uses DFS - pre-order
     * traversal to flatten the nodes.
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 11 ms. Above Average Run Time.
