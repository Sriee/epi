...
public class Matrix {
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 0ms. Optimal Solution Give a
     * matrix, rotate it by 90 degrees
     * 
     * @param matrix
     */
    ...
    /**
     * Flip matrix vertically. Similar to reversing an array using two pointer
     * approach.
     * 
     * @param matrix
     */
    ...
    public static void main(String[] args) {
        ...
        /*
         * m.transpose(matrix); m.flipVertical(matrix); m.printMatrix(matrix);
         */
    }
}
