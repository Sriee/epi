 ...
 * 
 * Reference:
 * 	Introduction to Algorithms CLRS - Chapter 32 Section 2
...
public class RabinKarp {
	...
	/**
	 * Searches for pattern in the given text
	 * 
	 * This method is similar to Java's indexOf() method. Note that it could easily extended to return index
	 * of all occurrences of pattern within string 
	 * 
	 * @param text
	 * @param pattern
	...
	public int search(String text, String pattern) {
		...
		for(int i = 1; i < m; i++) rm = (rm * radix) % modulus;
