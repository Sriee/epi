...
public class Range implements Iterable<Integer>, Iterator<Integer>{
	...
	public static List<Integer> range(int stop){
		Range.start = 0; Range.stop = stop; Range.step = 1;
	    return generateRange();
	}
	
	public static List<Integer> range(int start, int stop){
        Range.start = start; Range.stop = stop; Range.step = 1;
	    return generateRange();
	}
	...
	public static List<Integer> range(int start, int stop, int step){
		...
		Range.start = start; Range.stop = stop; Range.step = step;
    ...
    @Override
    public boolean hasNext() { return this.index < Range.stop; }
