...
public class KLargest {
    ...
    /**
     * Leet code problem. Solution -> Accepted Given a array of values, find the kth
     * largest element.
     * 
    ...
    /**
     * Leet code problem. Solution -> Accepted Compute the k most frequent numbers
     * 
     * @param nums
     * @param k
    ...
    /**
     * Leet code. Solution -> Accepted Calculate the kth smallest pairs from two
     * arrays
     * 
     * @param nums1 Array 1
     * @param nums2 Array 2
