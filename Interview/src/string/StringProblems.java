...
public class StringProblems {
    ...
    /**
     * Leet code. Solution -> Wrong Answer Perform C languages atoi. This problem
     * has lot of downvotes due to peculiar edge cases. The approach is correct.
     * Settling on it.
     * 
     * @param str
     * @return
     ...
     * string s1 and s2, check if s2 contains the permutation of s1. The string
     * consists of only lower case letter.
     * 
     * @param s1
     * @param s2
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 6 ms. Optimal run time Given a
     * string s and p, find the indices of all anagrams of p in s. Both the string
     * consists of only lower case letter.
     * 
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 2 ms. Optimal run time. Given a
     * string, find the length of the longest substring without repeating
     * characters.
     * 
     * @param s Given string
    ...
    /**
     * Leet code. Problem is locked Given a string, find the length of the longest
     * substring with atmost 2 distinct character. Variation: atmost k distict
     * character Example: "aaaabcdd" -> 5
     * 
     * @param s Given string
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 19 ms. Below average run time. Bulk
     * of the timing is going for accessing the map collection Given a string 's'
     * and a substring 't' find the minimum window of 't' in 's'. 't' can be in any
     * combination in s. The string only contains letters (both upper & lower case)
    ...
    /**
     * Leet code. Solution -> Accepted Run Time: 3 ms. Above average solution.
     * Calling character class is causing extra run time Given a string, find
     * whether it is a palindrome or not. String may contain other characters as
     * well. Ignore special characters, space and upper case letters.
     * 
     * @param s Given string
     * @return true if the
     */
