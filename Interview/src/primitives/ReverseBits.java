...
public class ReverseBits {
     ...
     * number do a bit wise complement on that number Example: Input: 5 (b'101) -> 2
     * (b'010)
     * 
     * @param N Number
     */
    ...
    public long reverseBits(long number) {
        ...
        return ((number >> 48) & 0xFFFF) | ((number >> 32) & 0xFFFF) << 16 | ((number >> 16) & 0xFFFF) << 32
                | (number & 0xFFFF) << 48;
    }
